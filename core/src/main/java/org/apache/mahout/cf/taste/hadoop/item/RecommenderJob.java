  ...
  public int run(String[] args) throws Exception {
    ...
    if (shouldRunNextPhase(parsedArgs, currentPhase)) {
      ...
      MultipleInputs.addInputPath(partialMultiply, similarityMatrixPath, SequenceFileInputFormat.class,
                                  SimilarityMatrixRowWrapperMapper.class);//输出 item,similarities
      MultipleInputs.addInputPath(partialMultiply, new Path(prepPath, PreparePreferenceMatrixJob.USER_VECTORS),
          SequenceFileInputFormat.class, UserVectorSplitterMapper.class);//输出 item,(user,pref)
      ...
      partialMultiply.setReducerClass(ToVectorAndPrefReducer.class);//输出 item,similarities,vector[(user,pref)]
